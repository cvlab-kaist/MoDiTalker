...
class LPIPSWithDiscriminator(nn.Module):
    def __init__(
        ...
        self.discriminator_2d = NLayerDiscriminator(input_nc=disc_in_channels, n_layers=disc_num_layers, ndf=disc_ndf).apply(weights_init)
        self.discriminator_3d = NLayerDiscriminator3D(input_nc=disc_in_channels, n_layers=disc_num_layers, ndf=disc_ndf).apply(weights_init)
    ...
    def forward(self, codebook_loss, inputs, reconstructions, optimizer_idx, global_step, cond=None, split="train", predicted_indices=None):
